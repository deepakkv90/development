      ...
      <div class="mid-cont">
        <div id="footer-nav" class="section flexbox align-center justify-center flex-wrap">
                ...
                <a class="" href="#" title="">Home</a>
                        ...
                        <div class="menu-item-wrapper">
                <a class="" href="#" target="_blank" title="">Delivery</a>
              </div>
                        <div class="menu-item-wrapper">
                <a class="" href="#" target="_blank" title="">Privacy Policy</a>
              </div>
                        <div class="menu-item-wrapper">
                <a class="" href="#" target="_blank" title="">Terms and Conditions</a>
              </div>
                        <div class="menu-item-wrapper">
                <a class="" href="#" target="_blank" title="">FAQs</a>
              </div>
                        <div class="menu-item-wrapper">
                <a class="" href="#" target="_blank" title="">Site Map</a>
              </div>
                  </div>
        ...
        <div class="section flexbox align-center justify-center" id="copyright">
          <p>&copy; 2018 Button Badges International.</p></p>
        </div>
      </div>
    </div>
<!-- Footer Part End-->
