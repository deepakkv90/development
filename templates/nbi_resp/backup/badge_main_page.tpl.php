		...
		<div id="m-header">
			<!-- Mobile Menu Start-->
			  <nav id="menu" class="m-menu"> <span><a href="javascript:void(0)">&nbsp;</a></span>
				<ul>
				  <li class="categories"><a>Name Plates</a>
					<div>
					  ...
					  <div class="column"> <a href="<?php echo HTTP_SERVER; ?>/p	ages.php?pID=27&amp;CDpath=0">Prices</a></div>
				...
				<header id="header">
				  ...
				  <nav id="menu">
					<ul>
					  ...
					  <li><a href="<?php echo HTTP_SERVER; ?>/p78/Artwork-guidelines/">Artwork</a></li>
					  <!--
					  <li><a>My Account</a>
						<div>
						  <ul>
