<?php
	...
	$categories_query = tep_db_query("select c.categories_id, cd.categories_name, c.categories_image, c.parent_id, c.sort_order, c.date_added, c.last_modified from " . TABLE_CATEGORIES . " c, " . TABLE_CATEGORIES_DESCRIPTION . " cd where c.parent_id IN ('0') and c.categories_id = cd.categories_id and cd.language_id = '" . (int)$languages_id . "'  order by cd.categories_id ASC");
			...
			<table border="0" cellspacing="2" cellpadding="2" align="center" width="90%">
			  ...
			  <tr>
				<td>
					...
					<form id="instantQuoteForm" name="instantQuoteForm" method="post" enctype="multipart/form-data" action="<?php echo tep_href_link("instant-quote-name-badge", '', 'SSL'); ?>">
