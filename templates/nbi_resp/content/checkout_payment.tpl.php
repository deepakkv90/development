...
?>
<style type="text/css">
	.product-grid .shipMethods table{
		margin: 0 auto;
	}
</style>
<div class="checkoutPaymentSection">
...
?>
	...
	<div class="content">
		...
		<div class="right">
			<?php echo TEXT_SELECTED_BILLING_DESTINATION; ?><br><br><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '" class="button">Change</a>'; ?>
		</div>
		<div class="clear"></div>
	</div>
...
<div class="content text-center checkoutShippingSection">
