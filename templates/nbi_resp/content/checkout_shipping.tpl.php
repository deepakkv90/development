...
?>
<div class="checkoutShippingSection">
<?php
...
<div class="content">
	...
	<div class="right">
		...
		if ($cre_RCO->get('checkoutshipping', 'changeaddressbutton') !== true) {
		  ...
		  echo TEXT_CHOOSE_SHIPPING_DESTINATION . '<br/><br/> <a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '" class="button">Change</a>';
