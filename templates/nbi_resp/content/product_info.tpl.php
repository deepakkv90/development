...
<div class="product-info">
  ...
  if ($product_check['total'] < 1) {
	...
	<br>
	<?php echo '<a class="button" href="' . tep_href_link(FILENAME_DEFAULT, $params) . '">Continue</a>'; 
    ...
    <div class="left">
            <?php if (tep_not_null($product_info['products_image']) || tep_not_null($product_info['products_image_med'])) { 
                  ...
                  ?>
				  <div class="image"><a href="<?php echo DIR_WS_IMAGES . $product_info['products_image_lrg'];?>" title="" class="cloud-zoom colorbox" id='zoom1' rel="adjustX: 0, adjustY:0, tint:'#000000',tintOpacity:0.2, zoomWidth:360, position:'inside', showTitle:false"><img src="<?php echo DIR_WS_IMAGES . $product_info['products_image_med'];?>" title="Canon EOS 5D" alt="Canon EOS 5D" id="image" /><span id="zoom-image"><i class="zoom_bttn"></i> Zoom</span></a></div>
				  <!--<div class="image-additional"> 
					<a href="templates/dsi/image/product/canon_eos_5d_1-500x500.jpg" title="Canon EOS 5D" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'templates/dsi/image/product/canon_eos_5d_1-350x350.jpg' "><img src="templates/dsi/image/product/canon_eos_5d_1-350x350.jpg" width="62" title="Canon EOS 5D" alt="Canon EOS 5D" /></a>
				  </div>-->
	...
	<?php
            echo '<h3>Price: ' . $products_price .'</h3>';
                ...
                foreach ($options as $oID => $op_data) {
                  switch ($op_data['type']) {
                    ...
                    case 5:
					  ...
					  <div class="content">
							<?php echo ($op_data['instructions'] != '' ? ' &nbsp;<span class="smallText">' . $op_data['instructions'] . '</span>' : '' ); ?>
							<br>
			  ...
			  <label for='cart_quantity' class="error">* Required Minimum Quantity : <?php echo $minimum_qty; ?></label> 
				<br>
                  ...
                  if (tep_db_num_rows($sub_products_sql) ==0) {
                    ...
                    if(!$dprid){?>
                    <?php echo TEXT_ENTER_QUANTITY . ':&nbsp;&nbsp;';?><br/>
                    <?php } ?>
                    
					  
					  <input type="hidden" name="hidminqty" id="hidminqty" value="<?php echo $product_info['products_min_order_qty']; ?>" />
   					  <input name="cart_quantity" id="cart_quantity" type="text" value="<?php echo (PRODUCT_LIST_MIN_ORDER_QTY == 1)?$minimum_qty:'1'; ?>"   
				...
				?>
				<input type="submit" class="button" value="<?php echo IMAGE_BUTTON_IN_CART; ?>" />
		</div>
