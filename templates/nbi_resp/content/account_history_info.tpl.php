  ...
  <div class="content">
	<table border="0" width="100%" cellspacing="0" cellpadding="2">
		...
		?>
						  <tr style="background-color:#d3e6f5;">
							<td class="main" align="center" style="padding:5px;"><b>QTY</b></td>
		...
		<?php
		  ...
		  for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
			...
			$result_sql = tep_db_fetch_array($query);    
		...
		//check for attibutes:
			...
			echo '</td><td class="main" valign="top" align="center">';
			 ...
			 if($order->info['orders_source']=="nbi") {
				echo '<a class="button" href="'.tep_href_link('index.php','cPath='.$result_sql['cat_id'].'&product_id='.$result_sql['products_id'].'&action=re-order&osCsid='.$_GET['osCsid']).'">Reorder</a>';
			 }
