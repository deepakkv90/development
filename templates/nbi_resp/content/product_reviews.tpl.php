...
//wishlist button
  ...
  if ((DESIGN_BUTTON_WISHLIST == 'true') && ( (!tep_not_null($wishlist_Pid[wPID])) && (tep_session_is_registered('customer_id')) ) ){
    echo tep_template_image_submit('button_add_wishlist.gif', IMAGE_BUTTON_ADD_WISHLIST);
  }
echo  '
                        </form>
</p></td>';
