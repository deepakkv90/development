	   ...
	   <div id="bgcolor_panel" style="display:block;">
		  ...
		  <div class="color_set" id="badge_bg_brush">
			<table class="preview_legend">
			  ...
			  <tr>
				<td><span class="badge_bg_brush" id="badge_bg_brush_gold"   rel="gold_brush.jpeg"></span></td>
				<td><span class="badge_bg_brush" id="badge_bg_brush_silver" rel="silver_brush.jpeg"></span></td>
			  </tr>
			</table>
		  </div>
