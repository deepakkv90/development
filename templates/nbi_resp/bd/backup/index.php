  ...
  <div class='badge_box'>
    ...
    <div class="content_in_tabs">
	   ...
	   <div class="color_set" id="badge_bg_brush">
			<strong>Select Background Brush</strong><br />
      ...
      <div id='badge_editor' class='badge_editor' style="display:block;">
		...
		<div id="text_color_set" style="display:block;">
			...
			<div class="color_set">
				<label>PMS</label>
				<input id="badge_text_color_pms" style="width:60px; height:10px;" value="0" type="text">        
			</div>
  ...
  <script type="text/javascript">
	...
	$('#badge_designer').badgeDesigner( { shapes_selector: $('#badge_shapes')
                                      ...
                                      /*, fonts: new Array( ''
														...
														, 'Bank Gothic Medium,font-family: Bank Gothic Medium'

														, 'Bradley Hand ITC,font-family: Bradley Hand ITC'

														, 'Broadway,font-family: Broadway'

														, 'Brush Script MT Italic,font-family: Brush Script MT Italic'

														, 'Californian FB,font-family: Californian FB'

														, 'Calisto MT,font-family: Calisto MT'
														...
														, 'Cooper Medium BT,font-family: Cooper Medium BT'
														...
														, 'Eras Medium ITC,font-family: Eras Medium ITC'
														...
														, 'Georgia Bold,font-family: Georgia Bold'

														, 'Georgia Italic,font-family: Georgia Italic'

														, 'Gigi,font-family: Gigi'
														...
														, 'Informal Roman,font-family: Informal Roman'
														...
														, 'Old English Text,font-family: Old English Text'
														...
														, 'Staccato 222 GT,font-family: Staccato 222 GT'

														, 'Stylus BT,font-family: Stylus BT'

														, 'Swiss 721Lt BT,font-family: Swiss 721Lt BT'
														...
														, 'Zapf Humanist Demi BT,font-family: Zapf Humanist Demi BT'
