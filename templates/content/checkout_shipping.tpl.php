...
echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'),'post','id="frm_checkout_ship"') . tep_draw_hidden_field('action', 'process'); ?><table border="0" width="100%" cellspacing="0" cellpadding="<?php echo CELLPADDING_SUB; ?>">
...
<?php
      ...
      $radio_buttons = 0;
	  $shipset = 0; //Modified on Aug 21, 2010
	  ...
	  <!--<tr>
        <td>
			...
			<table align="center" width="100%" border="0">
				<tr>
					<td width="10%"><b><?php echo TEXT_DUEDATE; ?> </b></td>
					<td width="90%">: <input type="text" validate="required:true" id="datepicker" name="due_date" value="<?php if(($_SESSION['due_date']!="")) echo date("d-m-Y", strtotime($_SESSION['due_date'])); ?>">
					 <br><label for="datepicker" class="error"> * <?php echo TEXT_PLEASE_SELECT_DUEDATE; ?></label>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<p><?php echo TEXT_DUEDATE_DESC; ?></p>
					</td>
				</tr>
			</table>
