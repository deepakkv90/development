...
div.submitQuote .note {
	...
	if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
		   ...
		   $captcha_err = "";
			...
			if($email_address!="" && empty($_POST["fillspm"])) {
				$mail->Send();
			...
			<table border="0" cellspacing="2" cellpadding="2" align="center" width="90%">
			  ...
			  <tr>
				<td>
					...
					<?php
					echo tep_draw_form('frm_contact_quote', tep_href_link(FILENAME_INSTANT_QUOTE, '', 'SSL'), 'post', 'id="instantQuoteForm"  enctype="multipart/form-data"') . tep_draw_hidden_field('action', 'process'); 
					...
					<div id="quoteCoupon" data-callback="instant_quote_coupon_process.php">
						<div class="couponRow addCoupon">
							...
							<div class="glassButton noPrint"><input type="button" value="<?php echo TEXT_USE; ?>" /></div>
							<div class="loadAnim">...</div>
						</div>
						<div class="couponRow removeCoupon" style="display: none;">
							<div class="activeCode"></div>
							<div class="glassButton noPrint"><input type="button" value="Remove" /></div>
						</div>
					</div>
					...
					<div class="submitQuote">
						...
						<div class="noPrint">
							...
							<div class="glassButton"><input type="submit" value="<?php echo CONTACT_QUOTE_SUBMIT; ?>" /></div>
							<div class="spacer20 clear"></div>
							
							<h2 class="print"><?php echo TEXT_PRINT_QUOTE; ?></h2>
							<div class="glassButton print"><button class="print"><?php echo TEXT_PRINT; ?></button></div>
