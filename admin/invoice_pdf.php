...
<page style="font-size:12px;" backtop="62mm" backbottom="38mm" backleft="8mm" backright="8mm">
		...
		<table style="width:100%;" border="0" cellspacing="0" cellpadding="0" class="main">
		  ...
		  <tr>
			<td align="center"  class="pdf-footer">
				...
				<span style="font-weight: bold;">Biller ID: 460287&nbsp; - Reference Number: Our Order/Invoice Number</span><br>
				<hr style="dotted">
