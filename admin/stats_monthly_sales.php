...
-->
      <tr>
        ...
        echo $PHP_SELF . "?" . $_SERVER['QUERY_STRING'] . "&print=yes";
        ?>" target="print" title="<?php echo TEXT_BUTTON_REPORT_PRINT_DESC . "\">" . TEXT_BUTTON_REPORT_PRINT; ?></a>
        </td>
        <td class="smallText"><a href='<?php echo $PHP_SELF . "?" . ereg_replace('&invert=yes','',$_SERVER['QUERY_STRING']);
...
if ($sel_month == 0 && !$print) {
  echo "<a href='" . $PHP_SELF . "?" . $_SERVER['QUERY_STRING'] . "&month=" . $sales['i_month'] . "&year=" . $sales['row_year'] . "' title='" . TEXT_BUTTON_REPORT_GET_DETAIL . "'>";
  }
          ...
          <table class="data-table-foot" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>            
              <td align="right" class="button-container">
                <form action="<?php echo $PHP_SELF; ?>" method=post><input type='hidden' name='csv' value='<?php echo $csv_accum; ?>'><input type='hidden' name='saveas' value='sales_report_<?php
