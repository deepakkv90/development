...
// EOF Separate Pricing per Customer
		...
		$accountant_name = tep_db_prepare_input($_POST['accountant_name']);
        $accountant_email = tep_db_prepare_input($_POST['accountant_email']);
		$submit_accountant_email_to_xero = tep_db_prepare_input($_POST['submit_accountant_email_to_xero']);
		//Set or Unset feedback email
		$send_feedback_email= tep_db_prepare_input($_POST['send_feedback_email']);
		if($send_feedback_email=='0') {
			//delete all the scheduled email in feedback info
			tep_db_query("DELETE FROM feedback_info WHERE customers_id='".$customers_id."' AND status=0");
		}
...
// BOF Separate Pricing Per Customer
      ...
      $customers_query = tep_db_query("select c.*, a.entry_company, a.entry_company_tax_id, a.entry_street_address, a.entry_suburb, a.entry_postcode, a.entry_city, a.entry_state, a.entry_zone_id, a.entry_country_id, a.entry_telephone as customers_telephone , a.entry_fax as customers_fax from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_default_address_id = a.address_book_id where a.customers_id = c.customers_id and c.customers_id = '" . (int)$_GET['cID'] . "'");
...
<!-- EOF Separate Pricing Per Customer -->
	...
	<!-- AJP accountant name and email updation -->	  	
	  <tr>
		<td class="main"><?php echo "Financial name"; ?></td>
		<td class="main">
			<?php 				
				echo tep_draw_input_field('accountant_name', (isset($cInfo->accountant_name) ? $cInfo->accountant_name : ''), 'maxlength="50" ');				
			?>
		</td>
	  </tr>	
	  <tr>
		<td class="main"><?php echo "Financial email"; ?></td>
		<td class="main">
			<?php 				
				echo tep_draw_input_field('accountant_email', (isset($cInfo->accountant_email) ? $cInfo->accountant_email : ''), 'maxlength="50" ');				
			?>
		</td>
	  </tr>	
	  <tr>
		<td class="main"><?php echo "Financial email to XERO:"; ?></td>
		<td class="main">
			<?php 				
				echo tep_draw_radio_field('submit_accountant_email_to_xero', '1', false, $cInfo->submit_accountant_email_to_xero) . '&nbsp;&nbsp;Yes&nbsp;&nbsp;' . tep_draw_radio_field('submit_accountant_email_to_xero', '0', false, $cInfo->submit_accountant_email_to_xero) . '&nbsp;&nbsp;No&nbsp;';				
			?>
		</td>
	  </tr>	
	  <tr>
		<td class="main"><?php echo "Send feedback email  :"; ?></td>
		<td class="main">
			<?php 				
				echo tep_draw_radio_field('send_feedback_email', '1', false, $cInfo->send_feedback_email) . '&nbsp;&nbsp;Yes&nbsp;&nbsp;' . tep_draw_radio_field('send_feedback_email', '0', false, $cInfo->send_feedback_email) . '&nbsp;&nbsp;No&nbsp;';				
			?>
		</td>
	  </tr>
