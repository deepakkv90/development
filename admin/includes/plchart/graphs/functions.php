<?php
/**
  * Some useful functions to generate the chart.
  * These functions are found from internet.
  */

# draw smooth line ( Author: nanobot@chipx86.com, From: http://www.php.net/manual/en/function.imageline.php, With some modifications )
