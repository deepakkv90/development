...
define('TEXT_ENEWS','eNews & Marketing');
...
define('TITLE', 'Name Badges International - sophisticated and custom designed name tags, badges and identification products');
...
define('HEADER_TITLE_CRELOADED', 'AJ PARKES');
...
define('BOX_CATALOG_DEFINE_HOMEPAGE', 'Define HomePage');
...
define('BOX_CATALOG_MANUFACTURERS', 'Family Product');
...
define('BOX_REPORTS_MONTHLY_SALES', 'Monthly Sales/GST - Tax');
...
define('IMAGE_SEND_INVOICE', 'Send Invoice');
...
define('TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> Family Product)');
...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date("Y") . '&nbsp;Name Badges International</a>, Powered by <a target="_blank" href="http://www.3wstarter.com">3Wstarter - eCommerce Solution</a>');
...
define('TEXT_CACHE_ALLMANUF', 'All Family Product');

define('TEXT_CACHE_ALLCATS', 'All Categories');

define('TEXT_CACHE_MANUFACTURERS', 'Family Product Box');
...
define('PASS_FORGOTTEN_FOOTER','eCommerce Solution by <a href="http://www.3wstarter.com" target="_blank">3WStarter</a>');
...
//define("CUSTOMER_ID","Customer ID"); //Sep 29 2011
define("CUSTOMER_ID","Account #");
...
define('IMAGE_CUSTOMER_FILES', 'Files');

define('IMAGE_ARTWORKS', 'Artworks');

define('ORDER_DETAILS', 'Order details');

define('BOX_CATALOG_QUICK_UPDATES', 'Quick Updates');

define('BOX_TOOLS_STOCK_OVERVIEW', 'Stock Overview');

define('DEFAULT_ORDER_SEARCH_TEXT', 'Search Order');
define('DEFAULT_NUMBER_SEARCH_TEXT', 'Search Account number');
define('DEFAULT_NAME_SEARCH_TEXT', 'Search Email/Name');
?>