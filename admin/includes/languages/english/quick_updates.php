...
define('TABLE_HEADING_QUANTITY', 'Stock Online');
...
define('TABLE_HEADING_PROGRESSED_QUANTITY', 'Stock in Progress');
define('TABLE_HEADING_OVERALL_QUANTITY', 'Stock On the shelf');

define('DISPLAY_OPTIONS', 'Select Products/Options');
