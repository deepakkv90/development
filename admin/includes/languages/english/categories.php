...
define('TEXT_PRODUCTS_IMAGE_MEDIUM_BORDER','<b>Real-size Image:</b><br><small>Used for badge image generation in real-size.</small>');
define('TEXT_PRODUCTS_IMAGE_NOTE_BORDER', '<b>Designer Image:</b><small><br>Used for designing badge.<small>');
define('TEXT_PRODUCTS_IMAGE_LARGE_BORDER', '<b>Additional designer image:</b><br><small>Used in badges with some internal images</small>');
define('TEXT_PRODUCTS_IMAGE_REAL_IMAGE2', '<b>Additional real-size image:</b><br><small>Corresponding real-size image for additional badge image</small>');
...
define('TEXT_PRODUCTS_MANUFACTURER', 'Family Product:');
...
define('TEXT_MAX_LINES_COUNT', 'Max Lines (-1 = unlimited):');
define('TEXT_MAX_IMAGES_COUNT', 'Max Images (-1 = unlimited):');
define('TEXT_DEFAULT_TEXTS', 'Default texts:');
...
define('TEXT_PRODUCTS_MIN_ORDER_QTY', 'Minimum Quantity:');  // min. order. qty. mod - Mar 03 2011
define('TEXT_PRODUCTS_COSTS', 'Product Costs:');
define('TEXT_PRODUCTS_LABOUR', 'Labour:');
define('TEXT_PRODUCTS_OVERHEAD', 'Overhead:');
define('TEXT_PRODUCTS_MATERIAL', 'Material:');
define('TEXT_OVERALL_QUANTITY', 'Overall Quantity:');
define('TEXT_PROGRESSED_QUANTITY', 'Progressing Quantity:');

 /* Badge settings Start */
define('TEXT_PRODUCTS_TYPE', 'Products type:');
define('TEXT_BADGE_PRODUCT', 'Badge');
define('TEXT_NONBADGE_PRODUCT', 'Non Badge');
define('TEXT_BADGE_PRODUCTS_BGCOLOR', 'BG Color Palette:');
define('TEXT_BADGE_PRODUCT_BGCOLOR_ON', 'On');
define('TEXT_BADGE_PRODUCT_BGCOLOR_OFF', 'Off');
define('TEXT_BADGE_PRODUCTS_TEXTCOLOR', 'Text Color Palette:');
define('TEXT_BADGE_PRODUCT_TEXTCOLOR_ON', 'On');
define('TEXT_BADGE_PRODUCT_TEXTCOLOR_OFF', 'Off');
define('TEXT_BADGE_PRODUCTS_FONTS', 'Font Option:');
define('TEXT_BADGE_PRODUCT_FONTS_ON', 'On');
define('TEXT_BADGE_PRODUCT_FONTS_OFF', 'Off');
define('TEXT_BADGE_PRODUCTS_BGBRUSH', 'BG Brush:');
define('TEXT_BADGE_PRODUCT_BGBRUSH_ON', 'On');
define('TEXT_BADGE_PRODUCT_BGBRUSH_OFF', 'Off');
/* Badge settings End */

define('TEXT_EDIT_SHOW_ON_QUOTE', 'Show in Instant Quote');
?>