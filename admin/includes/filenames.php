...
// MaxiDVD Added Line For WYSIWYG HTML Area: BOF
  ...
  define('FILENAME_DEFINE_HOMEPAGE', 'define_homepage.php');
...
// define the filenames used in the project
  ...
  define('FILENAME_ORDERS_INVOICE_PDF', 'invoice_pdf.php');
...
define('FILENAME_ENEWS', 'eNews/admin/index.php');
...
define('FILENAME_CUSTOMER_FILES','customer_files.php');

//Artwork and design

define('FILENAME_ARTWORKS','artworks.php');

define('FILENAME_ARTWORKS_INFO','artworks_info.php');

define('FILENAME_EDIT_ARTWORKS','edit_artworks.php');

define('FILENAME_QUICK_UPDATES', 'quick_updates.php');

define('FILENAME_STOCK_OVERVIEW', 'stock_overview.php');
?>