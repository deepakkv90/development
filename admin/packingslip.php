...
<tr>
  ...
  <TD ALIGN="left" VALIGN="left"><?php echo tep_image(DIR_WS_IMAGES . 'loaded_header_logo.png', STORE_NAME); //echo tep_image(DIR_WS_IMAGES . STORE_LOGO, STORE_NAME);  ?> </TD>
    ...
    <td align="right"><!-- sencot -->
      <FONT FACE="Verdana" SIZE="2" COLOR="#000000"> <?php echo "<br><br><b>". ENTRY_CUSTOMER_NUMBER. "</b>&nbsp;" . $customerNumber.'<br>' ; ?> </strong></font>
      <!-- fin sencot -->
    </td>
  </tr>
...
Biller ID: 460287&nbsp;- Reference Number: Our ORDER/INVOICE NUMBER<br>
----------------------------------------------------------------------------------------------<br>
<br>
...
<span style="color: rgb(255, 102, 102);">Please always use THE ORDER or INVOICE NUMBER as reference for your payment.</span></p>
	  ...
	  <tr><td align="center" class="dataTableContent">&#169; Copyright 2011 Name Badges International Pty Ltd&#46;&nbsp;&nbsp;&#124;&nbsp;&nbsp;ABN&#58;&nbsp;60 149 490 406</td>
	  </tr>
