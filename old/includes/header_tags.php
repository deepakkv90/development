...
{
   echo ' <meta name="Description" content="We are NO.1 Name Plate suppliers in Australia providing desk name plates, door name plates, Wedding plates & all types of name plates at the most discounted prices ever." />' . "\n";
   echo ' <meta name="Keywords" content="name plates, desk plates, door plates, office plates, name plates Australia" />' . "\n";
   echo ' <title>Customer Account - Name Badges International</title>' . "\n";
}

elseif($_SERVER['REQUEST_URI']=='/customer-account-login')
{
   echo ' <meta name="Description" content="Name Plates International supplies a variety of printed Quality name plates for corporate, professional, school & personalised." />' . "\n";
   echo ' <meta name="Keywords" content="name plates, login name plates international" />' . "\n";
   echo ' <title>Customer Login - Name Plates International</title>' . "\n";
}

elseif($_SERVER['REQUEST_URI']=='/shopping_cart.php')
{
   echo ' <meta name="Description" content="All our name plates comes with superior quality!. Order Your Name Plates Today & Get It Tomorrow." />' . "\n";
   echo ' <meta name="Keywords" content="order name plates, online name plates" />' . "\n";
   echo ' <title>Shopping Cart - Name Plates International</title>' . "\n";
}
...
echo ' <meta name="author" content="Name Plates International" />' . "\n";
echo ' <meta name="search engines" content="ALL" />' . "\n";
echo ' <meta name="YahooSeeker" content="INDEX, FOLLOW" />' . "\n";
...
<script type="application/ld+json">
{
  ...
  "@type" : "LocalBusiness",
  "name" : "Name Plates International",
  "image" : "http://nameplatesinternational.com.au/templates/nbi_resp/image/npi-logo.svg",
  "telephone" : [ "+612 8003 5046", "sales@nameplatesinternational.com.au" ],
  "address" : {
    "@type" : "PostalAddress",
    "streetAddress" : "Suite F Level 1 Octagon, 110 George Street",
    "addressLocality" : "Parramatta",
    "addressRegion" : "NSW",
    "addressCountry" : "Australia",
    "postalCode" : "2150"
  },
  "url" : "http://nameplatesinternational.com.au/"
}
</script>
...
<script type="application/ld+json">
{
  ...
  "@type" : "Product",
  "name" : "Name Plates",
  "image" : "http://nameplatesinternational.com.au/images/desk-plate-thumb.jpg",
  "description" : "Name Plates to make any office look professional. Fully customised.",
  "url" : "http://nameplatesinternational.com.au/",
  "brand" : {
    "@type" : "Brand",
    "name" : "Name Plates International",
    "logo" : "http://nameplatesinternational.com.au/templates/nbi_resp/image/npi-logo.svg"
  }
}
</script>
<!-- JSON-LD markup generated by Google Structured Data Markup Helper. -->
...
[ {
  ...
  "name" : "Desk Name Plates",
  "image" : "http://nameplatesinternational.com.au/images/desk-plate-thumb.jpg",
  "description" : "It creates the best impression of your office along with self presentation.",
  "url" : "http://nameplatesinternational.com.au/Desk-Name-Plates/c242/",
  "brand" : {
    "@type" : "Brand",
    "name" : "Name Plates International"
  }
