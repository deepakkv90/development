...
define('WISHLIST_SUB_PRODUCT_CHECKBOX_ERROR', 'To add the product in wishlist, you must have to check the checkbox');
define('WISHLIST_SUB_PRODUCT_INPUT_ERROR', 'To add the product in wishlist, you must have to add product quantity');
?>