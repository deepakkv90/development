...
define('HEADING_PURCHASE_NUMBER', 'Purchase Number');
...
define('CONDITION_AGREEMENT', ' have read the <a href="pages.php?pID=1" target="_blank">conditions of use</a> and I agree to them.');
