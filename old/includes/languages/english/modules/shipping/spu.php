...
define('MODULE_SHIPPING_SPU_TEXT_TITLE', 'Store Pickup - Brisbane only');
define('MODULE_SHIPPING_SPU_TEXT_DESCRIPTION', 'In-store pickup during regular business hours.');
define('MODULE_SHIPPING_SPU_TEXT_WAY', 'Packaging and Handling fees ONLY.  <br>Pickup during regular business hours.');
?>
