...
define("ARTWORK_CLIENT_FEEDBACK_CONFIRMATION_SUB", "Name Badges International revision request confirmation");
...
define('ARTWORK_CLIENT_FEEDBACK_CONFIRMATION_FOOTER','Yours Sincerely, %s' . "<br>" . 'Name Badges International Customer Support Team' . "<br>" . '
------------------------------------------------------------------------------------------------------------' . "<br>" . '
<b>Name Badges International </b>' . "<br>" . '
Suite F Level 1 Octagon, 110 George Street<br> Parramatta, NSW 2150 Australia' . "<br><br>" . '

<b>sales@namebadgesinternational.com.au | http://namebadgesinternational.com.au</b>' . "<br>" . '
