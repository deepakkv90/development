...
*/
  ...
  global $payment_modules, $shipping_modules, $order, $currencies, $cart,  $ip, $isp,
            $language, $currency, $languages_id, $order_total_modules, $order_totals, $next_id;
 ...
 if($session_exists) {
  ...
  if($session_exists) {
	...
	$order_status_hist_id = tep_db_insert_id();
...
*/
	...
	//insert orders products costs starts
	...
	//Orders products costs insertion ends
...
// call function to create this order in Crm    
  $order_id_cre = (int)$this->orders_id;
  manage_crm_order($order_id_cre,$order_status_hist_id);  
//End of call   manage_crm_orde
