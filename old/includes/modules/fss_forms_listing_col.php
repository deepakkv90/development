...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td class="smallText"><?php echo $listing_split->display_count(TEXT_DISPLAY_NUMBER_OF_FORMS); ?></td>
...
<?php
  ...
  if ($listing_split->number_of_rows > 0) {
    ...
    for ($x = 0; $x < $no_of_listings; $x++) {
      ...
      $lc_align = '';
      $lc_text = '&nbsp;<a href="' . tep_href_link(FILENAME_FSS_FORMS_DETAIL, (isset($fPath) ? 'fPath=' . $fPath . '&' : '') . 'forms_id=' . $listing[$x]['forms_id']) . '">' . $listing[$x]['forms_name'] . '</a>&nbsp;';      
