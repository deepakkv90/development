...
?>
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('postcode', (isset($entry['entry_postcode']) ? $entry['entry_postcode'] : ''),'maxlength="10" id="postcode"') . '&nbsp;' . (tep_not_null(ENTRY_POST_CODE_TEXT) ? '<span class="inputRequirement">' . ENTRY_POST_CODE_TEXT . '</span>': ''); ?></td>
          </tr>
          <tr>
            <td class="main"><?php echo ENTRY_CITY; ?></td>
            <td class="main"><?php echo tep_draw_input_field('city', (isset($entry['entry_city']) ? $entry['entry_city'] : ''), ' id="city" ') . '&nbsp;' . (tep_not_null(ENTRY_CITY_TEXT) ? '<span class="inputRequirement">' . ENTRY_CITY_TEXT . '</span>': ''); ?></td>
          </tr>
<?php
...
<?php
    if ($process == true) {
      if ($entry_state_has_zones == true) {
        ...
        echo tep_draw_input_field('state', $zones_values['zone_name'], ' id="state" ');
      }
    } else {
      echo tep_draw_input_field('state', tep_get_zone_name((isset($entry['entry_country_id']) ? $entry['entry_country_id'] : 0), (isset($entry['entry_zone_id']) ? $entry['entry_zone_id'] : 0 ), (isset($entry['entry_state']) ? $entry['entry_state'] : 0)), ' id="state" ');
    }
...
?>
          <tr>
            ...
            <td class="main"><?php echo tep_get_country_list('country', (isset($entry['entry_country_id']) ? $entry['entry_country_id'] : ''), ' id="country" ') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . '</span>': ''); ?></td>
          </tr>
<?php
