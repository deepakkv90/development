...
<tr>
  ...
  <TD ALIGN="left" VALIGN="left"><?php echo tep_image(DIR_WS_IMAGES . 'nbi_logo.png', STORE_NAME); //echo tep_image(DIR_WS_IMAGES . STORE_LOGO, STORE_NAME);  ?> </TD>
    <td align="right">
        ...
        &nbsp;&nbsp;&nbsp;<a href="javascript:window.close();"><img src='images/close_window.jpg' width="20" height="20" border=0></a>
	</td>
  </tr><tr>
    <td align="left">&nbsp;</td>
    <td align="right"><!-- sencot -->
      <FONT FACE="Verdana" SIZE="2" COLOR="#000000"> <?php echo "<b>". ENTRY_COMPANY_TAX_ID_NEW. "</b>&nbsp;" . $customerNumber.'<br>' ; ?> </strong></font>
      <!-- fin sencot -->
    </td>
  </tr>
  <tr>
...
?>
            <tr>
              ...
              <td align="right" colspan="3"><table border="0" cellspacing="0" cellpadding="3">
                  <?php
   ...
   echo '         <tr>' . "\n" .
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
	  ...
	  <tr>
		...
		For Payments over the Phone (Credit Card). Simply <span style="font-weight: bold;">Call 1300 267 074</span> and follow the prompts. <br> <span style="font-weight: bold;">Biller ID: 460287&nbsp; - Reference Number: your Order Number</span><br> -------------------------------------------------------------------------------------------------<br>
		For bank Transfer, please use the following details with THE ORDER NUMBER as reference to transfer your total order value:
	      <BR><strong>Account Name: Name Badges International Pty Ltd Account Number: BSB 034081 - Account# 263974<br>
