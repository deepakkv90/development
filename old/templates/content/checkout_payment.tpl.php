...
// beginning of the coupon redemption code
  if ($order_total_modules->credit_selection()!='' ) {
    $title_string = '';
    if (MAIN_TABLE_BORDER == 'yes') {
      $title_string .= table_image_border_top(false, false, TABLE_HEADING_CREDIT);
    } else {
      $title_string .= '<tr>' . "\n";
      $title_string .= '   <td><table border="0" width="100%" cellspacing="0" cellpadding="2">' . "\n";
      $title_string .= '      <tr>' . "\n";
      $title_string .= '        <td class="main"><b>' . TABLE_HEADING_CREDIT . '</b></td>' . "\n";
      $title_string .= '      </tr>' . "\n";
      $title_string .= '    </table></td>' . "\n";
      $title_string .= '  </tr>' . "\n";
    }
    echo $title_string;
?>
...
?>
	  ...
	  <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b><?php echo TABLE_HEADING_PURCHASE_NUMBER; ?></b></td>
          </tr>
        </table></td>
      </tr>
	      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td><?php echo tep_draw_input_field('purchase_number'); ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
