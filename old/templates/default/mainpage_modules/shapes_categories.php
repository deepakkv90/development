<?php
/*
  $Id: shapes_categories.php,v 1.0a 2002/08/01 10:37:00 Exp $
...
$item_column_number = 4;    // range of 1 to 9
...
//////////
 ...
 // $info_box_contents[] = array('align' => 'left', 'text'  => '<h2>'.BOX_HEADING_CATEGORIES_MAIN_PAGE.'</h2>');
...
$query_cat = "select 
  c.categories_id, 
  cd.categories_name, 
  cd1.categories_name parent_categories_name, 
  c.categories_image,
  c.parent_id from 
  " . TABLE_CATEGORIES . " c,
   " . TABLE_CATEGORIES . " c1,
  " . TABLE_CATEGORIES_DESCRIPTION . " cd,
  " . TABLE_CATEGORIES_DESCRIPTION . " cd1 
 where c.show_on_mainpage = 1
 and c.categories_id = cd.categories_id  
 and c1.categories_id = cd1.categories_id 
 and c.parent_id = c1.categories_id    
 and cd.language_id='" . $languages_id ."' 
 and cd1.language_id='" . $languages_id ."' 
...
while ($categories_cat = tep_db_fetch_array($categories_query_cat))
{
  ...
  if ($categories['parent_id'] == 0)
    ...
    $info_box_contents[$row][$col] = array('align' => 'left',
                                           'params' => 'class="smallText" width="23%" valign="top"',
                                           'text' => '<div class="shape_cat_block" '. $item_div_options . '><a href="' . tep_href_link(FILENAME_DEFAULT, $cpath_cat_new) . '"><span class="shape_cat_name" >' . $categories_cat['categories_name'] . '</span></a><br /><span class="parent_name">'.$categories_cat['parent_categories_name'].'</span><br /><a class="shape_cat_img" href="' . tep_href_link(FILENAME_DEFAULT, $cpath_cat_new) . '">' . tep_image(DIR_WS_IMAGES . $categories_cat['categories_image'], $categories_cat['categories_name'], SUBCATEGORY_IMAGE_WIDTH, SUBCATEGORY_IMAGE_HEIGHT) . '</a></DIV>');
...
print "<br /><p>With more than 100 years experience, AJ Parkes is Australia&#39;s best source for sophisticated and custom designed solutions 
for rewarding your staff, recognising outstanding achievement, promoting your business or school, and celebrating corporate events. 
Offering a huge and ever increasing range of products, specialist custom design services, state-of-the-art manufacturing techniques 
and an extensive and well established sourcing/distribution network, we are able tWith more than 100 years experience, AJ Parkes is 
Australia&#39;s best source for sophisticated and custom designed solutions for rewarding your staff, recognising.</p>";
print '<p class="logos"><a href="http://www.badgexpress.com.au/" target="_blank">
<img alt="Badge express" src="http://ajparkes.org/eShop/templates/Ajparkes1/images/badge_express.jpg" /></a>
<a href="http://www.motiv-8.com.au/" target="_blank">
<img alt="Motiv 8" height="43" src="http://ajparkes.org/eShop/templates/Ajparkes1/images/motiv8.jpg" width="192" /></a>
<a class="last" href="http://www.parkesmint.com.au/" target="_blank">
<img alt="Parkers mint" src="http://ajparkes.org/eShop/templates/Ajparkes1/images/parkers_mint.jpg" /></a></p>';

?>

<!-- shapes_categories_eof //-->