...
<script language="JavaScript" type="text/javascript" src="<?php echo (($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG . DIR_WS_TEMPLATES . TEMPLATE_NAME ;?>/js/fancybox/jquery.mousewheel-3.0.6.pack.js"></script>

<script language="JavaScript" type="text/javascript" src="<?php echo (($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG . DIR_WS_TEMPLATES . TEMPLATE_NAME ;?>/js/fancybox/jquery.fancybox.pack.js"></script>

<link rel="stylesheet" type="text/css" href="<?php echo (($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG . DIR_WS_TEMPLATES . TEMPLATE_NAME ;?>/js/fancybox/jquery.fancybox.css" />
...
if(isset($_GET['msg']) && $_GET['msg']!="") {
	...
	if($_GET['msg']=="suc") {
		echo "<div class='content' style='color:#0099FF;'>Feedback inserted successfully</div>";
		...
		?>
		  ...
		  <table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			if(tep_db_num_rows($artwork_query)>0) {
				...
				echo '<tr><td colspan="5" class="main main-left" style="padding:5px;">No Artworks available.</td></tr>';
			}
				...
				<!-- Feedback Start -->											
				  ...
				  <table id="option-feedback" align="center" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #DDD;">
					...
					<tr>
					  <td>&nbsp;</td>
					  <td>&nbsp;</td>
						<td><input class="button" type="button" value="Submit Feedback" onclick="return confirm_feedback();" /></td>
					</tr>
...
<div class="content">
	<table border="0" width="100%" cellspacing="0" cellpadding="2">
        ...
        <tr>
          <td colspan="1"><b>Disclaimer</b></td>
          </tr>
		<tr>
          <td colspan="1" style="border:1px dashed #CCC; padding:5px;">
