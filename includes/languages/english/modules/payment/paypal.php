...
*/
define('MODULE_PAYMENT_PAYPAL_TEXT_TITLE', 'PayPal Website Payments Standard');
define('MODULE_PAYMENT_PAYPAL_TEXT_DESCRIPTION', 'PayPal Website Payments Standard');
