...
define('TABLE_HEADING_PRODUCTS', 'Product Name'); //Modified Aug 25, 2010
define('TABLE_HEADING_SUB_TOTAL', 'Subtotal'); //Modified Aug 25, 2010
define('TABLE_HEADING_TOTAL', 'Total');
define('TEXT_CART_EMPTY', 'Your Shopping Cart is empty! Click <a href="http://buttonbadgesinternational.com.au/"><span style="color: #b80000;">here</span></a> to continue shopping.');
...
define('SUB_TITLE_GRAND_TOTAL_EXCL_TAX', 'Grand Total Excl. Tax:&nbsp;');
define('SUB_TITLE_TAX', 'Tax: ');
define('SUB_TITLE_GRAND_TOTAL_INCL_TAX', 'Grand Total Incl. Tax:&nbsp;');
