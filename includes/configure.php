...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('DIR_FS_CATALOG', $_SERVER['DOCUMENT_ROOT'].'/dev/');
...
// define our database connection
  ...
  define('NBI_SYNC', false);
  define('NBI_SOURCE_CODE', "api");
  define('NBI_ORDER_SYNC_URL', "https://localhost/APi/manage_orders.php");
  define('NBI_ACCOUNT_SYNC_URL', "https://localhost/APi/manage_accounts.php");
  define('NBI_NEXT_ORDERID_SYNC_URL', "https://localhost/APi/manage_get_next_order.php");
  //Set new or old designer
  define('NEW_DESIGNER', false);
